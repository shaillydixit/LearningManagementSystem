    ...
    <div class="topbar d-flex align-items-center">
        ...
        $profileData = App\Models\User::find($id);
            ...
            <div class="user-box dropdown px-3">
				...
				<img src="{{ (!empty($profileData->photo)) ? url('upload/instructor_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" class="user-img" alt="user avatar">                    <div class="user-info">
